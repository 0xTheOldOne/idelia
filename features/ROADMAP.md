...
|---|---|---|---|---|
| 001 | Bootstrap projet Vite | Initialiser Vite + Vue 3 (Options API) + Vuex + vue-router ; structure `src/` ([archi 06](../docs/architecture/06-structure-du-code.md)) ; SCSS + tokens ([style](../docs/instructions/style-scss.md)) ; Phosphor ; layout & navigation de base ; app qui démarre. | — | ⬜ |
